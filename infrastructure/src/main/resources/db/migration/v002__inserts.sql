...
INSERT INTO PRODUCT_PRICES(BRAND_ID, START_DATE, END_DATE, PRICE_LIST, PRODUCT_ID, PRIORITY, PRICE, CURR)
VALUES
        (1, parsedatetime('2020-06-14 00:00:00', 'yyyy-MM-dd HH:mm:ss'), parsedatetime('2020-12-31 23:59:59', 'yyyy-MM-dd HH:mm:ss'), 1, 35455, 2, 35.50, 'EUR'),
